...
export default function TrainingView() {
  const [selectedDisease, setSelectedDisease] = useState<'glaucoma' | 'retinopathy' | 'cataract'>('glaucoma')
      ...
      >
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-7 bg-white/10 border-white/20">
            ...
            <TabsTrigger value="ml-control" className="text-white data-[state=active]:bg-white/20">
            ...
            <TabsTrigger value="dataset" className="text-white data-[state=active]:bg-white/20">
              <Database className="w-4 h-4 mr-2" />
              Dataset
            </TabsTrigger>
            <TabsTrigger value="augmentation" className="text-white data-[state=active]:bg-white/20">
              <Layers className="w-4 h-4 mr-2" />
              Augmentation
            </TabsTrigger>
            <TabsTrigger value="evaluation" className="text-white data-[state=active]:bg-white/20">
              <BarChart2 className="w-4 h-4 mr-2" />
              Evaluation
            </TabsTrigger>
            <TabsTrigger value="tensorflow" className="text-white data-[state=active]:bg-white/20">
                      ...
                      <div className="grid md:grid-cols-3 gap-6">
                        {diseases.map((d, index) => (
                          ...
                          >
                            ...
                            } text-white hover:bg-white/15 transition-all duration-300`}>
